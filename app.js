...
function sumAndMultiply(a, b, c) {  //eslint-disable-line
   var adding = sum (sum(a,b)[0], c)[0];
   var multiplying = multiply (multiply(a,b)[0], c)[0];
   return [adding, multiplying, a + ' and ' + b + ' and ' + c + ' sum to ' + adding + '.', 'The product of ' + a + ' and '+ b +  ' and ' + c + ' is ' + multiplying + '.']
}
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  for (var i = 0; i < testArray.length; i++) {
    answer = sum(answer, testArray[i])[0];
  }
...
function multiplyArray(multArr) { //eslint-disable-line
  var answer1 = 1
  for (var i = 0; i < testArray.length; i++) {
    answer1 = multiply(answer1, testArray[i])[0];
  }
  return [answer1,'The numbers ' + testArray[0] +','+ testArray[1] +','+ testArray[2] + ' have a product of ' + answer1 + '.']; 
}
